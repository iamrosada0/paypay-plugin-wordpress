...
add_action('wp_enqueue_scripts', function () {
    // Enqueue CSS
    wp_enqueue_style('paypay-styles', plugin_dir_url(__FILE__) . 'assets/css/paypay.css', [], '1.0.2');
    // Enqueue JS
    wp_enqueue_script('paypay-frontend', plugin_dir_url(__FILE__) . 'assets/js/paypay.js', ['jquery'], '1.0.1', true);
...
add_shortcode('paypay_payment_form', function () {
    ...
    <div class="paypay-box">
        <form id="paypay-form">
            ...
            <input type="text" id="phone" name="phone" required pattern="\d{9}" placeholder="923123456">
